...
| 팀원 | 에이전트 정의 | 사용 스킬 |
|------|--------------|----------|
| spec-analyst | `.claude/agents/spec-analyst.md` | feature-spec |
| backend-dev | `.claude/agents/backend-dev.md` | springboot-conventions |
| frontend-dev | `.claude/agents/frontend-dev.md` | react-design-system |
| qa-validator | `.claude/agents/qa-validator.md` | integration-qa |
